<!-- Start Profile Card 8 -->
<?php use Elementor\Icons_Manager; ?>
<div class="profile-card-style-8">
    <img src="<?php echo esc_url($settings['profile_image']['url']); ?>" class="img img-responsive" alt="<?php echo esc_attr($settings['name']); ?>">
    ...
    <div class="profile-username elementor-profile-position-wrapper"><?php echo esc_attr($settings['position']); ?></div>
