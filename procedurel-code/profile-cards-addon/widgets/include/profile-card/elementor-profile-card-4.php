...
<div class="profile-card-style-4 text-center">
    <img src="<?php echo esc_url($settings['profile_image']['url']); ?>" style="width: 300px; height: px" class="img img-responsive" alt="<?php echo esc_attr($settings['name']); ?>">
